namespace Loja.Reports
{
	partial class relOrcamento
	{
		...
		private void InitializeComponent()
		{
			...
			this.tbl_OrcamentoAdapter1 = new Loja.dsOrcamentoTableAdapters.tbl_OrcamentoAdapter();
			this.dsOrcamento1 = new Loja.dsOrcamento();
			...
			// 
			// tbl_OrcamentoAdapter1
			// 
			this.tbl_OrcamentoAdapter1.ClearBeforeFill = true;
			// 
			// dsOrcamento1
			// 
			this.dsOrcamento1.DataSetName = "dsOrcamento";
			this.dsOrcamento1.EnforceConstraints = false;
			this.dsOrcamento1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			// groupHeaderBand1
			// 
			...
			// CodOrca
			// 
			resources.ApplyResources(this.CodOrca, "CodOrca");
            ...
            this.GroupFooter1,
            this.PageHeader});
			this.DataAdapter = this.tbl_OrcamentoAdapter1;
			this.DataMember = "tbl_Orcamento";
			this.DataSource = this.dsOrcamento1;
			...
			((System.ComponentModel.ISupportInitialize)(this.dsOrcamento1)).EndInit();
		...
		private dsOrcamentoTableAdapters.tbl_OrcamentoAdapter tbl_OrcamentoAdapter1;
		private dsOrcamento dsOrcamento1;
