namespace Loja.Reports
{
	partial class relResumoVendas
	{
		...
		private void InitializeComponent()
		{
            ...
            this.xrTableRow3});
			this.xrTable1.SizeF = new System.Drawing.SizeF(638F, 40F);
			// 
			// xrTableRow1
			// 
			...
			this.xrTableCell7.Weight = 190D;
			// 
			// xrTableCell8
			// 
			this.xrTableCell8.CanGrow = false;
			this.xrTableCell8.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "viw_ResumoDiario.Data")});
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.StyleName = "DataField";
			this.xrTableCell8.Text = "xrTableCell8";
			this.xrTableCell8.Weight = 190D;
			// 
			// xrTableCell9
			// 
			...
			this.xrTableCell10.Weight = 447D;
			// 
			// pageFooterBand1
			// 
			...
			this.xrLabel2.LocationFloat = new DevExpress.Utils.PointFloat(196.2982F, 10.00001F);
			this.xrLabel2.Name = "xrLabel2";
			this.xrLabel2.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrLabel2.SizeF = new System.Drawing.SizeF(447.7018F, 23F);
