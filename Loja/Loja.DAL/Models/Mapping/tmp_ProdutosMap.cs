...
{
	public class tmp_ProdutosMap : EntityTypeConfiguration<tmp_Produtos>
	{
		public tmp_ProdutosMap()
		{
			// Primary Key
			this.HasKey(t => new { t.CodProduto, t.DesProduto, t.DesLocal, t.codigounico });
