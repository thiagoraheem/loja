	...
	public class Monitor
	{
		...
		public static RetornoComando ImprimirDANFEPDF(string path)
		{
			...
			if (retorno.StartsWith("OK")) { 
				System.Diagnostics.Process.Start(retorno.Replace("OK: Arquivo criado em: ", ""));
			}
			return new RetornoComando(retorno);
        ...
        /// <summary>
        /// Inutiliza um número de NFe que não foi utilizado.
        /// </summary>
        /// <param name="cCNPJ">CNPJ emitente</param>
        /// <param name="cJustificativa">Justificativa para o cancelamento[OBRIGATÓRIO]</param>
        /// <param name="nAno">Ano que foi inutilizado a numeração</param>
        /// <param name="nModelo">Modelo da Nota Fiscal</param>
        /// <param name="nSerie">Série da Nota Fiscal</param>
        /// <param name="nNumInicial">Número Inicial a ser inutilizado</param>
        /// <param name="nNumFinal">Número Final a ser inutilizado</param>
        /// <returns></returns>
        public static RetornoComando InutilizarNFE(string cCNPJ, string cJustificativa, string nAno, string nModelo, string nSerie, string nNumInicial, string nNumFinal)
        {
            var comando = String.Format("NFE.InutilizarNFe(\"{0}\", \"{1}\", {2}, {3}, {4}, {5}, {6})", cCNPJ, cJustificativa, nAno, nModelo, nSerie, nNumInicial, nNumFinal);
